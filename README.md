# PT2399 UGen
  ...
  <a href="https://github.com/schollz/pt2399-sc/releases/latest"><img src="https://img.shields.io/github/v/release/schollz/pt2399-sc" alt="Version"></a>
  <a href="https://github.com/schollz/pt2399-sc/actions/workflows/release.yml"><img src="https://github.com/schollz/pt2399-sc/actions/workflows/release.yml/badge.svg" alt="Build Status"></a>
...
Go to [releases](https://github.com/schollz/pt2399-sc/releases/latest), download the `.zip` file for your system and unzip it into the SuperCollider Extensions directory: `~/.local/share/SuperCollider/Extensions`.
...
```bash
git clone git@github.com:schollz/pt2399-sc
cd pt2399
make install
```
